...
const AddTractor = () => {
  ...
  const [form, setForm] = useState({ tractorName: '', tractorType: '', pricePerHour: '', location: '' })
  ...
  const validate = () => {
    ...
    if (!form.pricePerHour || form.pricePerHour < 100)   errs.pricePerHour = 'Minimum price is ₹100/hr'
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ✅ FIXED: /tractor/addTractor (not /tractorAdd/addTractor)
      await axios.post(`${BASE}/tractor/addTractor`, form, { withCredentials: true })
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className={`flex items-center gap-3 bg-[#0a150a] border-2 rounded-xl px-4 py-3.5 transition-colors ${
                ...
                <input type="text" placeholder="e.g. Mahindra 575"
              ...
              <div className="grid grid-cols-2 gap-2">
                {tractorTypes.map(type => (
                  <label key={type} className="cursor-pointer">
                    <input type="radio" name="tractorType" value={type}
            ...
            <div>
              ...
              <div className={`flex items-center gap-3 bg-[#0a150a] border-2 rounded-xl px-4 py-3.5 transition-colors ${
                ...
                <input type="number" placeholder="Minimum ₹100" min="100"
            ...
            <div>
              ...
              <div className={`flex items-center gap-3 bg-[#0a150a] border-2 rounded-xl px-4 py-3.5 transition-colors ${
                ...
                <input type="text" placeholder="e.g. Ahmedabad, Gujarat"
                  value={form.location}
