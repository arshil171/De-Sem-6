                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <div className="relative">
                    ...
                    <div className="flex flex-col gap-3 mt-4">
                        {fireData ? ( <Home userName={data.user.displayName}  
                        setFireData={setFireData}/>) : (
                        <button onClick={handleLogin} className="flex items-center justify-center gap-2 py-2 border border-gray-300 rounded-lg bg-gray-100 cursor-pointer transition"> 
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48" className="w-5 h-5"> 
